...
func NewTaxCodeModel(archived bool, companyId string, createdAt shared.Time, id string, name string, rate float32, type_ string, updatedAt shared.Time) *TaxCodeModel {
	this := TaxCodeModel{}
...
func (o *TaxCodeModel) GetCreatedAt() shared.Time {
	if o == nil {
		var ret shared.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TaxCodeModel) GetCreatedAtOk() (*shared.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TaxCodeModel) SetCreatedAt(v shared.Time) {
	o.CreatedAt = v
}
...
func (o *TaxCodeModel) GetUpdatedAt() shared.Time {
	if o == nil {
		var ret shared.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TaxCodeModel) GetUpdatedAtOk() (*shared.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TaxCodeModel) SetUpdatedAt(v shared.Time) {
	o.UpdatedAt = v
}
